...
public class MessageConfirmDialog {
	...
	public static void show(Activity activity, String title, String content,
		...
		show(activity, title,content, "取消","确定", listener,cancel);
	}

	public static void show(Activity activity, String title, String content, String btn1, String btn2,
                            final OnConfirmClickListener listener, boolean cancel){
		...
		window.setContentView(R.layout.message_two_view_default);// 设置内容布局
