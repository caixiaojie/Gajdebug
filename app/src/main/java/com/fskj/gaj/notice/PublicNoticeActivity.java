...
public class PublicNoticeActivity extends AppCompatActivity {
    ...
    public static void gotoActivity(Activity activity ){
        Intent intent=new Intent(activity,PublicNoticeActivity.class);

        activity.startActivity(intent);
    }

    public static void gotoActivity(Fragment fr ){
        Intent intent=new Intent(fr.getActivity(),PublicNoticeActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activity=PublicNoticeActivity.this;
